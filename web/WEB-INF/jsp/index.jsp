...
<html>
    ...
    <%-----<head>
        ...
        <title>DB adopción</title>
    </head>

    <body id="imgprincipal">  ----%>
        <%---------
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">DB adopción</h1>
        <p class="lead text-muted">En DB adopciòn estamos para ayudar a nuestros amigos peluditos</p>
        <p>
        ...
        <div class="col" >
          <div class="card shadow-sm">
            <svg class="bd-placeholder-img card-img-top" width="50%" height="150" 
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
         <a href="frmUsuario.htm" class="btn btn-primary my-2">Formulario de usuarios</a>
         <a href="frmMascotas.htm" class="btn btn-secondary my-2">Formulario de adopción</a>
         <a href="listarUsuarios.htm" class="btn btn-secondary my-2">listar usuarios</a>
         <a href="listarMascotas.htm" class="btn btn-secondary my-2">listar mascotas</a>
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              <p class="card-text">Tiene un perro considerado de raza peligrosa? encuentre aqui los lineamientos de la ley 746 de 2002.</p>
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
